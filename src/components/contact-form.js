    ...
    emailjs
      ...
      .then(
        ...
        function (error) {
          ...
          setFormMessage(
            "Your message couldn't be sent. Please email Priya directly at mambufrancis1998@gmail.com"
          );
        }
      );
  }
    ...
    <Form onSubmit={sendEmail} id="contactForm">
      ...
      <Form.Group controlId="email">
        ...
        <Form.Control
          ...
          name="email"
          type="email"
          placeholder="mambufrancis1998@gmail.com"
          onBlur={handleChange}
        />
      </Form.Group>
